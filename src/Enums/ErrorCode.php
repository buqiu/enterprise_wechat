...
class ErrorCode
{
    public static function message(mixed $code): mixed
    {
        return match ($code) {
            1     => '系统繁忙',
            0     => '请求成功',
            ...
            60229 => '成员或者部门id不正确',
            60230 => '缺少shareticket',
            60231,60234,60233 => 'shareticket非法',
